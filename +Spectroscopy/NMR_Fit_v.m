...
%
classdef NMR_Fit_v < Spectroscopy.NMR_Mix_v
    ...
    methods
        function obj = applyGlobalPhaseShift(obj, phaseShiftInDegrees)
            ...
            obj = applyGlobalPhaseShift@Spectroscopy.NMR_Mix_v(obj,phaseShiftInDegrees);
        ...
        function obj = NMR_Fit_v(time_domain_signal, t, ...
            ...
            obj = obj@Spectroscopy.NMR_Mix_v(area,freq,fwhm,fwhmG,phase);
