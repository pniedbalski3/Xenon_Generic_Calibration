...
%
classdef NMR_Fit < Spectroscopy.NMR_Mix
    ...
    methods
        function obj = applyGlobalPhaseShift(obj, phaseShiftInDegrees)
            ...
            obj = applyGlobalPhaseShift@Spectroscopy.NMR_Mix(obj,phaseShiftInDegrees);
        ...
        function obj = NMR_Fit(time_domain_signal, t, ...
            ...
            obj = obj@Spectroscopy.NMR_Mix(area,freq,fwhm,phase);
